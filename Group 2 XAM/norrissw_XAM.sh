...
######################################
FILE1=$1
#/gaia/bnfo620/norrissw/newXAM/lil1796_1.fastq
FILE2=$2
#/gaia/bnfo620/norrissw/newXAM/lil1796_2.fastq
REFERENCE=$3
#/gaia/bnfo620/norrissw/newXAM/hg19.fa
SAMBAM=$4
#lil1796
...
#/usr/global/blp/bin/bwa aln ${REFERENCE} ${FILE1} >${FILE1}aln_.sai
#/usr/global/blp/bin/bwa aln ${REFERENCE} ${FILE2} >${FILE2}aln_.sai

#Transform .sai to .SAM format  use bwa sampe command for paired end reads
#/usr/global/blp/bin/bwa sampe ${REFERENCE} ${FILE1}aln_.sai ${FILE2}aln_.sai ${FILE1} ${FILE2} >${SAMBAM}.sam
...
#java -jar /usr/global/blp/picard-tools-1.95/CreateSequenceDictionary.jar REFERENCE=${REFERENCE} OUTPUT=/gpfs_fs/home/bnfo620/norrissw/newXAM/hg19.dict
...
#java -jar /usr/global/blp/GenomeAnalysisTK-3.1.1/GenomeAnalysisTK.jar -I ${SAMBAM}.no_dups.bam -R /gpfs_fs/home/bnfo620/norrissw/newXAM/hg19.fa -T IndelRealigner -targetIntervals ${SAMBAM}.bam.list -o ${SAMBAM}.realigned.bam
